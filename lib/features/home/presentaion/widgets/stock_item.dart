...
import 'package:y_s_flutter_task_mostafa_ameen/features/detels/presentaion/screens/stock_Details_Screen.dart';
...
class StockItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: ()
      {
         context.read<StockBloc>().add(FetchDetails(stackItem.symbol));
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => StockDetailsScreen(stackItem: stackItem),
                        ),
                      );
      },
      child: Card(
